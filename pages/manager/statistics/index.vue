<template>
  <div class="container">
    ...
    <section>
      ...
      <Charts :data="last7" :x="array_7.x" :y="array_7.y" />
    </section>
    <section>
      <h4>
        اخر 30 يوم بعدد <span class="tomato">{{ last30.length }} </span>سياره.
      </h4>
      <Charts :data="last30" :x="array_30.x" :y="array_30.y" />
    </section>
    <section>
      <h4>
        اخر 365 يوم بعدد
      ...
      <Charts :data="last_year" :x="array_365.x" :y="array_365.y" />
    </section>
  </div>
</template>
...
export default {
  async asyncData({ $axios }) {
    ...
    return { last1, last7, last30, last_year };
  },
  middleware: "manager",
  head() {
